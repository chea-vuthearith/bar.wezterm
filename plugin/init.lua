...
local function get_require_path()
  local path = "httpssCssZssZsgithubsDscomsZschea-vuthearithsZsbarsDswezterm"
  local path_trailing_slash = "httpssCssZssZsgithubsDscomsZschea-vuthearithsZsbarsDsweztermZs"
